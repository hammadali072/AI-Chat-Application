...
const HeroSection = () => {
  return (
    <section className="py-8 text-center sm:py-12 max-w-[900px] mx-auto">
      ...
      <h1 className="text-3xl font-extrabold tracking-tight text-black sm:text-5xl md:text-6xl">AI PDF Question &amp; Answering System</h1>

      <p className="mt-4 text-base font-normal leading-relaxed text-grey sm:text-lg">Upload course materials, lecture notes or research documents and receive instant AI answers grounded directly in your PDF content.</p>
